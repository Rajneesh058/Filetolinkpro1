...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://github.com/Rajneesh058'>CLICK HERE FOR SUPPORT </a></b>",
    ...
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/19ad6ad1d04e540328efd.jpg",
        caption =f"<i>👋 Hᴇʏ </i>{m.from_user.mention(style=enums.ParseMode.HTML)}!,\n
<i>I ᴀᴍ Tᴇʟᴇɢʀᴀᴍ Fɪʟᴇs Sᴛʀᴇᴀᴍɪɴɢ Bᴏᴛ ᴀs ᴡᴇʟʟ Dɪʀᴇᴄᴛ Lɪɴᴋs Gᴇɴᴇʀᴀᴛᴇ</i>\n
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try: 
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Rajneesh Singh](https://github.com/Rajneesh058).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://github.com/Rajneesh058")],
                [InlineKeyboardButton("💥 Source Code", url="https://github.com/Rajneesh058/filetolinkpro")]
            ]
        )
    )
